...
Drop files into `99 Attachments/source-portal/` then run `python3 scripts/ingest_ro_portal.py --convert KEY`. Ledger: [[Currency ledger]]. Full operator queue (all batches + analysis backlog): [[Audit & Roadmap — downloads and analysis backlog]].

## Still needed (high priority)

- [ ] **Codul fiscal (L227/2015)** — latest forma consolidată PDF / Forma printabilă from [consolidare 01.07.2026](https://legislatie.just.ro/Public/DetaliiDocument/311621) / Afis [311622](https://legislatie.just.ro/Public/DetaliiDocumentAfis/311622). Working text today is SOAP full (`171282`) but older. Partial newer dump: `311622_cod-fiscal-227-2015_consolidat-2026-07-01-TRUNCATED-1MB.md` (~1 MB WebFetch cap).
- [ ] **Codul de procedură fiscală (L207/2015)** — latest forma consolidată ([L207 shell](https://legislatie.just.ro/Public/DetaliiDocument/170005) / Afis [309359](https://legislatie.just.ro/Public/DetaliiDocumentAfis/309359), through **08.05.2026**). Same SOAP lag (`170007`).

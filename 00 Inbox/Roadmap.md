...
- Folder scaffold aligned to EU/MD model: `00 Inbox` · `01 Legal system` · `10 Legislation/{Constitution,Codes,Laws,Ordinances,Government Decisions,Regulator Acts}` · `20 Domains` · `20 Position Papers` · `30 Concepts` · `50 MOCs` · `60 Authorities` · `90 Templates` · `99 Attachments/source-*` · `uploads/`
- [[Conventions]], `.obsidian`, templates, [[Home]], [[SOURCE INDEX]]
...
## Done — Primary legislation (`10 Legislation/`)
...
| `source-portal/` — Batch B (16 acts) | See [[SOURCE INDEX]] → `10 Legislation/` |
...
- [[MOC — Energetică]] · [[MOC — Piete de echilibrare]] · [[MOC — Fiscalitate]] · [[MOC — Societăți & Guvernanță]] · [[00 - Index general]]
...
- [[Piete de echilibrare — synthesis]] — PCE/PE/SS/IBS architecture
- [[MOC — Piete de echilibrare]] — navigation hub
...
- Wired into [[MOC — Energetică]] · concepts · [[Energetică — synthesis]] · [[_Energy Investment Due Diligence Index]]
...
| Transelectrica — **balancing market** / redispatch rules | Imbalance pricing; curtailment compensation detail | Analysis: [[Piete de echilibrare — synthesis]]; Ord. 127/213 text ingest pending |
...
4. **Never:** bulk-ingest individual Decizii — see [[Conventions]] scope rule.
